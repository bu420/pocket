...
int main() {
    ...
    llsr_color_buffer_clear(&canvas, (llsr_byte3_t){255, 255, 255});

    llsr_raster_line(&canvas, (llsr_int2_t){10, 10}, (llsr_int2_t){90, 90}, (llsr_byte3_t){255, 0, 0});
    llsr_raster_line(&canvas, (llsr_int2_t){10, 90}, (llsr_int2_t){90, 10}, (llsr_byte3_t){0, 0, 255});
